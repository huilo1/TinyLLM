...
Практическая оговорка по GPU-хостам:

- в `pyproject.toml` `torch` ограничен сверху `<2.11.0`;
- это сделано потому, что на части недорогих серверов Vast.ai драйверы еще не готовы к самым новым `cu130` wheel'ам;
- такое ограничение снижает шанс, что `uv` автоматически поставит несовместимую сборку PyTorch.
