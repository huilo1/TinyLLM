...
После выкладки remote worker не обязан уже работать на GPU-хосте: вебка поднимает его лениво по первому запросу и повторно поднимает после reboot/обрыва SSH-сессии.
